  ...
  return (
    <div>
      ...
      <div className="swap-container mt-5 text-white">
        ...
        <Form.Group className="my-3" controlId="exampleForm.ControlInput1">
          ...
          <InputGroup className="w-full">
            <Form.Control
              placeholder="Minimum convertion Amount 10000"
              type="number"
              step="0.01"
              name="quota"
        ...
        <div className="d-flex my-2 align-items-center justify-content-center gap-3">
      ...
      <div className=" swap-container-btn ">
        <Button variant="primary" className="w-100 py-3 px-5 fw-semibold">
          CONFIRM
        </Button>
      </div>
    </div>
